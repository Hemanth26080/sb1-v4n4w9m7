        ...
        <div className="space-y-8">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-300">
           ...
           <div className="flex gap-4">
            <a href="/src/components/P_Hemanth_Resume.pdf" download="P_Hemanth_Resume.pdf" className="flex items-center gap-2 px-6 py-3 bg-blue-900 dark:bg-cream text-white dark:text-blue-900 rounded-lg hover:bg-blue-800 dark:hover:bg-cream/90 transition-colors">
